    ...
    <div :hidden="studentCheck(staff)">
      <div class="row">
        <div class="col-6">
          ...
          <b-form-select
            v-model="addClassStaff"
            :options="availableClassesStaff"
            size="sm"
            class="mt-3"
            :select-size="getSize(availableClassesStaff)"
          ></b-form-select>
        ...
        <div class="col-6">
          ...
          <b-form-select
            v-model="removeClassStaff"
            :options="pickedClassesStaff"
            size="sm"
            class="mt-3"
            :select-size="getSize(pickedClassesStaff)"
          ></b-form-select>
      ...
      <div class="row">
        <div class="col-6">
          ...
          <b-form-select
            ...
            size="sm"
            class="mt-3"
            :select-size="getSize(availableClasses)"
          ></b-form-select>
        ...
        <div class="col-6">
          ...
          <b-form-select
            v-model="removeClass"
            :options="pickedClasses"
            size="sm"
            class="mt-3"
            :select-size="getSize(pickedClasses)"
          ></b-form-select>
  ...
  methods: {
    ...
    removeClasses: function() {
      if (this.removeClass != null) {
        let classes = this.pickedClasses.filter(
          classes => classes.value == this.removeClass
        );
        ...
        this.pickedClasses = this.pickedClasses.filter(
          classes => classes.value != this.removeClass
        );
    ...
    staffAdd: function() {
      ...
      this.addClasses(
        this.availableClassesStaff,
        this.pickedClassesStaff,
        this.addClassStaff,
        this.removeClassStaff
      );
